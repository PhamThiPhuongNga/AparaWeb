...
//------------------------------------------------------------------------------------
$('#subscribe-field-halfbg-form').validate({
    onfocusout: false,
    onkeyup: false,
    rules: {
		name: "required",
...
$('#subscribe-field-halfbg-form').submit(function () {
    // submit the form
    //data area
    var data = [];
    ...
    if ($(this).valid()) {
        ...
        $.ajax({
            ...
            processData: false,
            success: function () {
                $('#subscribe-field-halfbg-form').find('[type=submit]').button('complete');
            },
            error: function () {
                $('#subscribe-field-halfbg-form').find('[type=submit]').button('reset');
            }
        });
    } else {
